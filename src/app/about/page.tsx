...
export default function AboutPage() {
  return (
    <div className='p-8 bg-cream-white min-h-screen text-center'>
      <h1 className='text-soft-blue text-4xl mb-4'>About Kitso</h1>
      ...
      <p className='text-gray-700 mb-4'>
        We believe that education and support are essential for navigating life’s transitions with confidence. Kitso combines expert knowledge with a user-friendly design to ensure that our resources are both informative and easy to use. Our goal is to make learning about these important topics engaging and empowering.
      </p>
      <p className='text-gray-700 mb-4'>
        At Kitso, we are committed to continuous improvement and responsiveness to user needs. We welcome feedback and suggestions to help us enhance our platform and better serve our community. Thank you for visiting, and we hope you find the information and support you need on your journey.
      </p>
      <p className='text-gray-700'>
        For more information or inquiries, please contact us at <a href='mailto:support@kitso.com' className='text-soft-blue underline'>support@kitso.com</a>.
      </p>
    </div>
  );
}
